...
router.route("/").get((req, res) => {
        hotelPackage.find().then((hotelPackages)=>{
...
router.route("/update/:id").put(async(req, res) => {
        ...
        const update = await hotelPackage.findByIdAndUpdate(packageId , updateHotelPackage)
            .then(() => {
...
router.route("/delete/:id").delete(async(req, res) => {
        let packageId = req.params.id;
        await hotelPackage.findByIdAndDelete(packageId).then(() => {
...
router.route("/get/:id").get(async(req, res) => {
    let packageId = req.params.id;
    const user =  await hotelPackage.findById(packageId ).then((hotelPackage) => {
